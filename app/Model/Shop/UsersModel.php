...
class UsersModel extends BackEndModel
{
    ...
    public function __construct() {
        ...
        $this->crudNotAccepted     = ['_token','isnumber','password_confirmation','password_old','submit','btn-register','task','id','code_ref'];
    }
    public function getItem($params = null, $options = null) {
        ...
        if ($options['task'] == 'get-item-api') {
            $result = self::select('user_id', 'email', 'fullname', 'phone', 'user_type_id','ref_register','codeRef')
