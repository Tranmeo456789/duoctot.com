...
Route::group(['prefix' => $prefixShopBackEnd, 'namespace' => 'Shop\BackEnd', 'middleware' => ['check.login']], function () { 
    ...
    Route::get('/export-list-post-file-excel', 'OrderController@exportListPostFileExcel');
    Route::get('/export-list-product-file-excel', 'OrderController@exportListProductFileExcel');
    ...
    Route::group(['middleware' => ['permission.editorOrAdmin']], function () {
        ...
        Route::get('/sua-phan-hoi-khach-hang/{id}', 'CustomerFeedBackController@form')->name('customerFeedback.edit');
        Route::post('/luu-phan-hoi-khach-hang', 'CustomerFeedBackController@save')->name('customerFeedback.save');
        Route::get('/xoa-phan-hoi-khach-hang/{id}', 'CustomerFeedBackController@delete')->name('customerFeedback.delete');
