...
use App\Model\Shop\CustomerFeedBackModel as MainModel;
use Illuminate\Http\Request;
use App\Http\Controllers\Shop\BackEnd\BackEndController;
use App\Model\Shop\CatalogModel;
use App\Model\Shop\UsersModel;
use App\Http\Requests\CustomerFeedBackRequest as MainRequest;
...
class CustomerFeedBackController extends BackEndController
{
    public function __construct()
    {
        $this->controllerName     = 'customerFeedback';
        $this->pathViewController = "$this->moduleName.pages.$this->controllerName.";
        $this->pageTitle          = 'Danh sách phản hồi của khách hàng';
