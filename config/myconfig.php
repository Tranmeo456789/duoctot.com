    ...
    return [
        ...
        'template' => [
            ...
            'label' => [
                ...
                'general_info' =>'Thông tin bổ sung thêm (thêm thẻ H2 tương ứng các đầu mục 6,7,8...)',
                'benefit' => '2 Tác dụng - Chỉ định',
                'elements'=>'1 Thành phần',
                'prescribe' => 'Chỉ định',
                'dosage' => '3 Liều dùng - Cách dùng',
                'note' => '4 Lưu ý',
                'preserve' => '5 Bảo quản',
                ...
                'discount_tdoctor'=>'Chiết khấu NCC cho DuocTot.com(%)',
                ...
                'brand_manufacturer'=>'Thương hiệu, Nhà sản xuất',
        ...
        'urlSitemap' => [
                ...
                ['url' => env('APP_URL') . 'product9-sitemap.xml', 'last_modified' => '2026-06-01 04:57:00'],
                ['url' => env('APP_URL') . 'product10-sitemap.xml', 'last_modified' => '2026-06-01 04:57:00'],
                ['url' => env('APP_URL') . 'product11-sitemap.xml', 'last_modified' => '2026-06-01 04:57:00'],
