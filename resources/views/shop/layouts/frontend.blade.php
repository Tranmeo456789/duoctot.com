@php
    $title = $item['name'] ?? $item['title'] ?? $title ?? 'DƯỢC TỐT là Nền tảng kết nối y dược nhà thuốc, phòng khám , bệnh nhân với công ty dược và thực phẩm chức năng uy tín hàng đầu Việt Nam';
    $imageItem = $imageItem ?? $item['image'] ?? 'images/shop/logo-favicon.png';
    $description = $item['description'] ?? $item['meta_description'] ?? 'DƯỢC TỐT là Nền tảng kết nối y dược nhà thuốc, phòng khám , bệnh nhân với công ty dược và thực phẩm chức năng uy tín hàng đầu Việt Nam.';
