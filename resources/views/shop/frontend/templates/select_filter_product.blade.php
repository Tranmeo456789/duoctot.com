...
<div class="wp-slect-customer">
    <div class="slect-customer">
        <div class="d-flex gap-2">
            ...
            <div>
                <span class="slect-item-customer {{$k==0?'active-slect':''}}" data-object="{{$item['slug']}}" data-href="{{route('fe.home.ajaxfilter')}}">
                    <p>{{$item['name']}}</p>
                    <div class="icon-sticky"><span><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
