...
<li>
    <div class="d-flex">
        @for ($i = 0; $i < $val['level']; $i++) <div style="width:30px;">
    </div>
    @endfor
    <div>
        ...
        <p class="mt-1">
            <span class="text-primary repply-comment btn" data-toggle="modal" data-target="#replyModal" data-commenter-name="{{ $fullname }}" data-comment-id="{{ $val['id'] }}">Trả lời</span>
        </p>
    </div>
    </div>
</li>