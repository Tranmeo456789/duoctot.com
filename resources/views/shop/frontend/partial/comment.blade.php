...
<li>
    <div class="d-flex">
        ...
        <div>
            ...
            <p class="mt-1">
                <span class="text-primary repply-comment btn" data-commenter-name="{{ $fullname }}" data-comment-id="{{ $val['id'] }}">Trả lời</span>
            </p>
        </div>
    </div>
</li>
...
<li>
    <div class="d-flex">
        ...
        <div>
            ...
            <p class="mt-1">
                <span class="text-primary repply-comment btn" data-commenter-name="{{ $fullname }}" data-comment-id="{{ $val['parent_id'] }}">Trả lời</span>
            </p>
        </div>
    </div>
</li>
