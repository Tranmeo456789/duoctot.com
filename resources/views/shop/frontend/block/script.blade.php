...
<script src="{{ asset('/shop/frontend/js/jquery-3.1.1.min.js')}}?t=@php echo time() @endphp" type="text/javascript"></script>
<script src="{{ asset('/shop/frontend/js/combined_library.min.js')}}?t=@php echo time() @endphp" type="text/javascript"></script>
