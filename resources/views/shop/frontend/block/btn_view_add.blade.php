...
<span class="mt-2 d-flex justify-content-center w-100 align-items-center">
    <span class="view-btn-add-product p-2 btn" data-type="{{$type??''}}" data-object="{{$typeObject??''}}" data-idcat="{{$idCat??null}}" data-offset="{{$dataOffset??20}}" data-href="{{route('fe.product.loadMoreProducts')}}">
