<style>
    ...
    .ls_product_moi_ban_chay li .wp-img-thumb-product {
        height: 180px;
        display: flex;
        justify-content: center;
        align-items: center;
    }
    .ls_product_moi_ban_chay li p {
        color: #1E1E1E;
        line-height: 18px;
        padding-top: 4px;
    }
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        tns({
            container: ".ls_product_moi_ban_chay",
            items: 5,
            slideBy: "page",
            loop: true,
            speed: 3000,
...
<div class="clearfix list-unstyled ls_product_moi_ban_chay ls_product-view-add">
