...
<div class="wp-inner mt-3 mt-lg-4">
    <div class="abu-cnt">
        ...
        <div class="info-secu">
            ...
            <p>Quý khách vui lòng liên hệ với tdoctor.net qua Hotline : 0393 167 234 hoặc gửi Email: tdoctorvn@gmail.com , cung cấp thông tin chi tiết về sản phẩm lỗi gồm:</p>
            <div class="ml-1">
