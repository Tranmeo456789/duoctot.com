...
<div class="wp-inner mt-3 mt-lg-4">
    <div class="abu-cnt">
        ...
        <div class="top-new">
            <p style="font-size: 16px;">Chúng tôi là DƯỢC TỐT là Nền tảng kết nối y dược nhà thuốc, phòng khám , bệnh nhân với công ty dược và thực phẩm chức năng uy tín hàng đầu Việt Nam với những bác sĩ nhiều kinh nghiệm, chúng tôi phục vụ người bệnh mọi lúc mọi nơi. <a style="font-size: 16px; color: #2b96cc;" href="https://duoctot.com/">duoctot.com</a> là công ty công nghệ với mong muốn sẽ xây dựng được một hệ thống chăm sóc sức khỏe toàn diện thông qua ứng dụng trên điện thoại và web. Ứng dụng tdoctor trên smartphone / tablet phiên bản Android và IOS cung cấp dịch vụ chăm sóc sức khỏe chủ động đầu tiên tại Việt Nam. Dựa trên nền tảng công nghệ thông tin, ứng dụng tdoctor giúp kết nối người dùng và Bác Sĩ dễ dàng ở mọi lúc, mọi nơi. Người dùng có thể sử dụng ứng dụng để được tư vấn sức khỏe, tra cứu SP & phòng khám, cùng các dịch vụ sức khỏe khác.</p>
            <br />
            <div class="mb-3 text-center">
            ...
            <br>
            <h4 class="h4-abu">2. Văn hóa tại <a class="link-p" href="https://duoctot.com/">www.duoctot.com</a></h4>
