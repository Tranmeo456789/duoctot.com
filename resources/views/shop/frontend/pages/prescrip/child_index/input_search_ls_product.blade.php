<div class="content text-center">
    <div class="content-top-2">
        <div class=" position-relative">
            <input class="input-prescrip pd-left-40 search-product-keyup" data-href="{{route('fe.product.searchProductAjax')}}" type="text" value="{{$keyword??''}}" placeholder="Vui lòng nhập tên thuốc cần tìm">
