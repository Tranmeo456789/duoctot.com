<style>
    ...
    .ls_san_pham_khuyen_mai li .wp-img-thumb-product {
        height: 180px;
        display: flex;
        justify-content: center;
        align-items: center;
    }
    .ls_san_pham_khuyen_mai li p {
        color: #1E1E1E;
        line-height: 18px;
        padding-top: 4px;
    }
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        tns({
            container: ".ls_san_pham_khuyen_mai",
            items: 5,
            slideBy: "page",
            loop: true,
            speed: 3000,
...
<div class="clearfix list-unstyled ls_san_pham_khuyen_mai ls_product-view-add">
        ...
        <li class="position-relative">
            <a href="{{route('fe.product.detail',$val['slug'])}}" class="d-block">
                <div class="wp-img-thumb-product mb-2">
                    <img loading="lazy" src="{{asset('public'.$val['image'])}}" alt="{{$val['name']}}" width="180" height="180" decoding="async">
                </div>
                <div class="pl-1">
