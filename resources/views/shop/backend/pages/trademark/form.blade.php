@php
    ...
    $elements = [
        [
            'label'   => HTML::decode(Form::label('name', 'Tên Thương hiệu' .  $star, $formLabelAttr)),
            'element' => Form::text('name', $item['name']??null, array_merge($formInputAttr,['placeholder'=>'Tên Thương hiệu'])),
            'widthElement' => 'col-12'
        ],[
