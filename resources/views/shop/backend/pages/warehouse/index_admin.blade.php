                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8">
                        <div class="row">
                            ...
                            <div class="text-center col-12"><button class="btn btn-primary filter-in-time" data-href="{{route('user.filterInDay')}}" data-controller="warehouse">Lọc kết quả</button></div>
                        </div>
                    </div>
                </div>
            </div>
