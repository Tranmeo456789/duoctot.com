            ...
            @if (count($items) > 0)
                @foreach ($items as $val)
                    ...
                    <tr>
                        ...
                        <td style="width: 25%" class="text-center">{{$val->user_id}}</td>
                        <td style="width: 25%" class="text-center">{!! $fullname !!}</td>
                        ...
                        <td style="width: 20%" class="text-center">
                            ...
                            <a data-href="{{route("$controllerName.delete",$val->user_id)}}" class="btn btn-sm btn-danger btn-delete text-white" data-id="{{$val->id}}" data-toggle="tooltip" data-placement="top" title="Xóa" data-token="{{csrf_token()}}">
