                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8">
                        <div class="row">
                            ...
                            <div class="text-center col-12"><button class="btn btn-primary filter-in-time" data-href="{{route('user.filterInDay')}}" data-controller="order">Lọc kết quả</button></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body p-0">
                <div class="list-user-admin">
                    @include("$moduleName.pages.$controllerName.admin.child_index.table_list")
                </div>
            </div>
