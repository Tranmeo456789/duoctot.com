    ...
    if (isset($item['list_products']) && (count($item['list_products']) > 0)) {
        foreach($item['list_products'] as $keyProduct => $product) {
            $elementsDetails[] = [
                [
                    'label'   => '',
                    'element' => Form::select('list_products[product_id][]',['null' => '-- Chọn thuốc -- '] + $itemsProduct,$product['product_id'], array_merge($formSelect2Attr,['style' =>'width:100%','data-href' => $linkGetProduct])),
                    'widthElement' => 'col-4'
                ],[
                    'label'   => '',
        ...
        $elementsDetails[] = [
            [
                'label'   => '',
                'element' => Form::select('list_products[product_id][]',['null' => '-- Chọn thuốc -- '] + $itemsProduct,null, array_merge($formSelect2Attr,['style' =>'width:100%','data-href' => $linkGetProduct])),
                'widthElement' => 'col-4'
            ],[
                'label'   => '',
