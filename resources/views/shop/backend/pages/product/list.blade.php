    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="width: 15%">
                ...
                <a href="" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Thêm ảnh sản phẩm"><i class="fas fa-plus"></i></a>
            </td>
        </tr>
        @endforeach
    </tbody>
