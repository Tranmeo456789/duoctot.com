@php
    ...
    $elements = [
        ...
        [
            ...
            'element' => Form::text('slug', $item['slug']??null, array_merge($formInputAttr,['placeholder'=>'Nếu để trống tự động lấy theo slug tên thuốc'])),
            'type'    => "url-page",
            'widthInput' => 'col-12',
        ],
        [
    ...
    $elements2= [
            [
                'label'   => HTML::decode(Form::label('number_registered',$label['number_registered'], $formLabelAttr)),
                'element' => Form::text('number_registered', $item['number_registered']??'', array_merge($formInputAttr,['placeholder'=>$label['number_registered']])),
                'widthElement' => 'col-6'
            ],
            [
    ...
    $elements2 = array_merge($elements2,
        [
            ...
            [
                ...
                'label'   => Form::label('brand_manufacturer', $label['brand_manufacturer'], $formLabelAttr),
                'element' => Form::textarea('brand_manufacturer', $item['brand_manufacturer']?? null, array_merge($formEditorAttr,['placeholder'=>$label['brand_manufacturer'],"rows"=>"3"]))
            ],
            [
                'label'   => Form::label('company_registered', $label['company_registered'], $formLabelAttr),
                'element' => Form::textarea('company_registered', $item['company_registered']?? null, array_merge($formEditorAttr,['placeholder'=>$label['company_registered'],"rows"=>"3"]))
            ],
            [
                'label'   => Form::label('elements_mini', $label['elements_mini'], $formLabelAttr),
                'element' => Form::textarea('elements_mini', $item['elements_mini']?? null, array_merge($formEditorAttr,['placeholder'=>$label['elements_mini'],"rows"=>"3"]))
            ],
            [
            ...
            ,[
                ...
                'label'   => HTML::decode(Form::label('general_info', $label['general_info'], $formLabelAttr)),
