@php
    ...
    $elements2= [
            ...
            [
                ...
                'element' => Form::text('contact', $item['contact']??'0393167234', array_merge($formInputAttr,['placeholder'=>'SĐT liên hệ'])),
                'widthElement' => 'col-3'
            ],[
    ...
    $elements2 = array_merge($elements2,
        [
            [
                ...
                'element' => Template::showImageAndInputSingleFile('image', '/public'.$item['image']?? ('/public'.$item['details']['image']??null)),
                'widthInput' => 'col-11',
            ],[
