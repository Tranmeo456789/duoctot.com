                    ...
                    <table class="table table-striped">
                        ...
                        <tbody id="list-img">
                            ...
                            <tr>
                                ...
                                <td style="width: 20%">
                                    <a href="{{route('dropzone.img.delete',[$temp,$products->id])}}" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
