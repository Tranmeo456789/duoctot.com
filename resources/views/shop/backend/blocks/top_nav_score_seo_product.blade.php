...
<nav class="main-header navbar navbar-expand-md navbar-white">
    ...
    <div data-analyze-url="{{ route('admin.seo-score.analyze') }}" data-csrf="{{ csrf_token() }}">
        <div class="d-flex align-items-center justify-content-between">
            <strong class="mr-2">Thang điểm SEO:</strong>
            <div>
                <span id="seo-score-circle-product" class="badge" style="font-size:16px;padding:6px 14px;border-radius:20px;">--/100</span>
            </div>
        </div>
    </div>
    <!-- Right navbar links -->
