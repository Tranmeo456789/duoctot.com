        ...
        <form action="{{route('warehouse.update',$warehouse->id)}}" method="POST">
            ...
            <div class="row">
                <div class="form-group col-12">
                    ...
                    <input class="form-control" type="text" name="name" id="" value="{{$warehouse['name']}}" placeholder="Nhập tên kho hàng" autocomplete="off">
                    @if($errors->has('name'))
            ...
            <div class="text-center"><button type="submit" name="btn_update_warehouse" value="1" class="btn btn-primary">Cập nhật</button></div>
        </form>
    </div>
</div>
@endsection